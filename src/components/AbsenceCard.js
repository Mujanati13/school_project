...
export default function AbsenceCard({title , date}) {
    ...
    <div className="mt-3">
      ...
      {showSlide == true ? 
        <div className="text-sm flex items-center space-x-10 border-2 border-gray-100 ml-10 w-11/12 h-10  bg-gray-100 pt-1 pl-5">
          <div className="flex items-center space-x-2"><div className="w-2 h-2 bg-red-500 rounded-full"></div> <span>Absence</span></div>
          <div>{date}</div>
